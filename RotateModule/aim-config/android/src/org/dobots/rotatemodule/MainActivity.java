package org.dobots.rotatemodule;
...
import org.dobots.rotatemodule.aim.*;
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.rotatemodule", "org.dobots.rotatemodule.aim.RotateModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (RotateModuleService.class.getName().equals(service.service.getClassName())) {
