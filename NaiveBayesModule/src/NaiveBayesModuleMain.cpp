/**
 * @file NaiveBayesModuleMain.cpp
 * @brief Entry function for NaiveBayesModule
 *
 ...
 * have this file and the NaiveBayesModule header and code in a separate "aim" directory.
 */
int main(int argc, char *argv[])  {
	NaiveBayesModuleExt *m = new NaiveBayesModuleExt();
