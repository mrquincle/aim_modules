...
public class NaiveBayesModuleService extends Service {
	private static final String TAG = "NaiveBayesModuleService";
...
//	}
	...
	private class AIMRun extends AsyncTask<Integer, Void, Boolean> {
		protected Boolean doInBackground(Integer... id) {
			...
			int input = 3;
			NaiveBayesModule aim = new NaiveBayesModule();
...
//		}
	...
	// static constructor
	static {
		System.loadLibrary("NaiveBayesModule");
	}
