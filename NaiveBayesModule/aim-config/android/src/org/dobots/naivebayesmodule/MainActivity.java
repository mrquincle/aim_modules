package org.dobots.naivebayesmodule;
...
import org.dobots.naivebayesmodule.aim.*;

public class MainActivity extends Activity {
private static final String TAG = "MainActivity";
private static final String MODULE_NAME = "NaiveBayesModule";
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.naivebayesmodule", "org.dobots.naivebayesmodule.aim.NaiveBayesModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (NaiveBayesModuleService.class.getName().equals(service.service.getClassName())) {
