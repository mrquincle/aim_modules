package org.dobots.datasetmodule;
...
import org.dobots.datasetmodule.aim.*;

public class MainActivity extends Activity {
private static final String TAG = "MainActivity";
private static final String MODULE_NAME = "DatasetModule";
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.datasetmodule", "org.dobots.datasetmodule.aim.DatasetModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (DatasetModuleService.class.getName().equals(service.service.getClassName())) {
