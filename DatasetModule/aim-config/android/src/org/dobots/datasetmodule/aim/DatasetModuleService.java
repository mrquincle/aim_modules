package org.dobots.datasetmodule.aim;
...
public class DatasetModuleService extends Service {
	private static final String TAG = "DatasetModuleService";
...
//	}
	...
	private class AIMRun extends AsyncTask<Integer, Void, Boolean> {
		protected Boolean doInBackground(Integer... id) {
			...
			int input = 3;
			DatasetModule aim = new DatasetModule();
...
//		}
	...
	// static constructor
	static {
		System.loadLibrary("DatasetModule");
	}
