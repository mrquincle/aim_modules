package org.dobots.recommendermodule;
...
import org.dobots.recommendermodule.aim.*;

public class MainActivity extends Activity {
private static final String TAG = "MainActivity";
private static final String MODULE_NAME = "RecommenderModule";
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.recommendermodule", "org.dobots.recommendermodule.aim.RecommenderModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (RecommenderModuleService.class.getName().equals(service.service.getClassName())) {
