package org.dobots.recommendermodule.aim;
...
public class RecommenderModuleService extends Service {
	private static final String TAG = "RecommenderModuleService";
...
//	}
	...
	private class AIMRun extends AsyncTask<Integer, Void, Boolean> {
		protected Boolean doInBackground(Integer... id) {
			...
			int input = 3;
			RecommenderModule aim = new RecommenderModule();
...
//		}
	...
	// static constructor
	static {
		System.loadLibrary("RecommenderModule");
	}
