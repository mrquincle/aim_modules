package org.dobots.dirichletmodule.aim;
...
public class DirichletModuleService extends Service {
	private static final String TAG = "DirichletModuleService";
...
//	}
	...
	private class AIMRun extends AsyncTask<Integer, Void, Boolean> {
		protected Boolean doInBackground(Integer... id) {
			...
			int input = 3;
			DirichletModule aim = new DirichletModule();
...
//		}
	...
	// static constructor
	static {
		System.loadLibrary("DirichletModule");
	}
