/**
 * @file HorizonModuleMain.cpp
 * @brief Entry function for HorizonModule
 *
 ...
 * have this file and the HorizonModule header and code in a separate "aim" directory.
 */
int main(int argc, char *argv[])  {
	HorizonModuleExt *m = new HorizonModuleExt();
