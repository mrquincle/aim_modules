/**
 * @file RFXcomModuleMain.cpp
 * @brief Entry function for RFXcomModule
 *
 ...
 * have this file and the RFXcomModule header and code in a separate "aim" directory.
 */
int main(int argc, char *argv[])  {
	RFXcomModuleExt *m = new RFXcomModuleExt();
