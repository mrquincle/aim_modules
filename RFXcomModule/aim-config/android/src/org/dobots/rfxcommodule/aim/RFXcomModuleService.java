package org.dobots.rfxcommodule.aim;
...
public class RFXcomModuleService extends Service {
	private static final String TAG = "RFXcomModuleService";
...
//	}
	...
	private class AIMRun extends AsyncTask<Integer, Void, Boolean> {
		protected Boolean doInBackground(Integer... id) {
			...
			int input = 3;
			RFXcomModule aim = new RFXcomModule();
...
//		}
	...
	// static constructor
	static {
		System.loadLibrary("RFXcomModule");
	}
