package org.dobots.rfxcommodule;
...
import org.dobots.rfxcommodule.aim.*;

public class MainActivity extends Activity {
private static final String TAG = "MainActivity";
private static final String MODULE_NAME = "RFXcomModule";
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.rfxcommodule", "org.dobots.rfxcommodule.aim.RFXcomModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (RFXcomModuleService.class.getName().equals(service.service.getClassName())) {
