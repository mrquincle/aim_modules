...
enum ILVQ_DistanceMetric { IDM_EUCLIDEAN, IDM_DOTPRODUCT, IDM_TYPES };
...
public:
	...
	ILVQ_TYPE distance(const ILVQ_ASPECT & aspect, const ILVQ_PROTOTYPE & prototype, ILVQ_DistanceMetric metric);
